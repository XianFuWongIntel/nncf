#ifndef _COMMON_DPCPP_DEFS_DP_HPP_
#define _COMMON_DPCPP_DEFS_DP_HPP_
...
inline sycl::range<3>
get_2d_grid_size_for_per_channel(const uint32_t scale_count)
{
    ...
    return sycl::range<3>(1, grid_size_y, grid_size_x);
}
...
#endif // _COMMON_DPCPP_DEFS_DP_HPP_
