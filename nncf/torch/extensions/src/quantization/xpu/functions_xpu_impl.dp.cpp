...
#include "common_xpu_funcs.dp.hpp"
...
void fakeQuantize(
    ...
    */
    (*output) =
        round((fmin(fmax((*input), (*input_low)),
...
void q_single_scale_xpu_backward_kernel(
...
template <typename scalar_t, typename scalar_accum_t>
void q_scale_per_weight_channel_xpu_backward_kernel(
        scalar_t* __restrict__ grad_input,
        scalar_t* __restrict__ grad_input_low,
        scalar_t* __restrict__ grad_input_range,
        scalar_accum_t* __restrict__ dev_tmp_range,
...
template <typename scalar_t, typename scalar_accum_t>
void q_scale_per_activation_channel_xpu_backward_kernel(
        scalar_t* __restrict__ grad_input,
        scalar_t* __restrict__ grad_input_low,
        scalar_t* __restrict__ grad_input_range,
        scalar_accum_t* __restrict__ dev_tmp_range,
...
std::vector<at::Tensor> q_single_scale_xpu_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
    ...
    */
    PROFILE(AT_DISPATCH_FLOATING_TYPES_AND_HALF(
                input.scalar_type(), "q_single_scale_xpu_backward", ([&] {
          ...
          */
          ...
          cgh.parallel_for(
              sycl::nd_range<3>(
                  ...
                  sycl::range<3>(1, 1, CUDA_MAX_NUM_THREADS_PER_BLOCK)),
              [=](sycl::nd_item<3> item_ct1) {
                q_single_scale_xpu_backward_kernel<scalar_t, scalar_accum_t>(
...
std::vector<at::Tensor> q_scale_per_weight_channel_xpu_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
    ...
    auto dev_tmp_range = at::zeros({(long)grid_size[2], (long)grid_size[1]}, accum_options);
    auto dev_tmp_low = at::zeros({(long)grid_size[2], (long)grid_size[1]}, accum_options);
    auto dev_last_block_counter_range =
        at::zeros({(long)grid_size[2], 1},
          ...
          */
          ...
          cgh.parallel_for(
              sycl::nd_range<3>(
                  ...
                  sycl::range<3>(1, 1, CUDA_MAX_NUM_THREADS_PER_BLOCK)),
              [=](sycl::nd_item<3> item_ct1) {
                q_scale_per_weight_channel_xpu_backward_kernel<scalar_t,
                                                                scalar_accum_t>(
                    grad_input_data_ptr_scalar_t_ct0,
                    grad_input_low_data_ptr_scalar_t_ct1,
                    grad_input_range_data_ptr_scalar_t_ct2,
...
std::vector<at::Tensor> q_scale_per_activation_channel_xpu_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
    ...
    */
    PROFILE(AT_DISPATCH_FLOATING_TYPES_AND_HALF(
                input.scalar_type(),
                "q_scale_per_activation_channel_xpu_backward", ([&] {
          using scalar_accum_t = ACCUM_TYPE_FOR(scalar_t);
          /*
          ...
          */
          ...
          cgh.parallel_for(
              sycl::nd_range<3>(
                  ...
                  sycl::range<3>(1, 1, CUDA_MAX_NUM_THREADS_PER_BLOCK)),
              [=](sycl::nd_item<3> item_ct1) {
                q_scale_per_activation_channel_xpu_backward_kernel<
...
std::vector<at::Tensor> q_xpu_backward(
    ...
    {
        case ScaleType::PER_ACTIVATION_CHANNEL:
            return q_scale_per_activation_channel_xpu_backward(
                grad_output,
                input,
                input_low,
                input_range,
                ...
                level_high);
        case ScaleType::PER_WEIGHT_CHANNEL:
            return q_scale_per_weight_channel_xpu_backward(
                grad_output,
                input,
                input_low,
                input_range,
        ...
        default:
            return q_single_scale_xpu_backward(
                grad_output,
                input,
                input_low,
                input_range,
