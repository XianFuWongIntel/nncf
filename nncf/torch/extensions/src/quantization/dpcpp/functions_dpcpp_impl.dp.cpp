...
#include "common_dpcpp_funcs.dp.hpp"
#include "common_dpcpp_defs.dp.hpp"
...
void q_single_scale_dpcpp_backward_kernel(
...
template <typename scalar_t, typename scalar_accum_t>
void q_scale_per_weight_channel_dpcpp_backward_kernel(
        scalar_t* __restrict__ grad_input,
        scalar_t* __restrict__ grad_input_low,
        scalar_t* __restrict__ grad_input_range,
        scalar_accum_t* __restrict__ dev_tmp_range,
...
template <typename scalar_t, typename scalar_accum_t>
void q_scale_per_activation_channel_dpcpp_backward_kernel(
        scalar_t* __restrict__ grad_input,
        scalar_t* __restrict__ grad_input_low,
        scalar_t* __restrict__ grad_input_range,
        scalar_accum_t* __restrict__ dev_tmp_range,
...
std::vector<at::Tensor> q_single_scale_dpcpp_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
    ...
    */
    PROFILE(AT_DISPATCH_FLOATING_TYPES_AND_HALF(
                input.scalar_type(), "q_single_scale_dpcpp_backward", ([&] {
...
std::vector<at::Tensor> q_scale_per_weight_channel_dpcpp_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
...
std::vector<at::Tensor> q_scale_per_activation_channel_dpcpp_backward(at::Tensor grad_output,
        at::Tensor input,
        at::Tensor input_low,
        at::Tensor input_range,
        int levels,
    ...
    */
    PROFILE(AT_DISPATCH_FLOATING_TYPES_AND_HALF(
                input.scalar_type(),
                "q_scale_per_activation_channel_dpcpp_backward", ([&] {
          using scalar_accum_t = ACCUM_TYPE_FOR(scalar_t);
          /*
...
std::vector<at::Tensor> q_dpcpp_backward(
    ...
    {
        case ScaleType::PER_ACTIVATION_CHANNEL:
            return q_scale_per_activation_channel_dpcpp_backward(
                grad_output,
                input,
                input_low,
                input_range,
                ...
                level_high);
        case ScaleType::PER_WEIGHT_CHANNEL:
            return q_scale_per_weight_channel_dpcpp_backward(
                grad_output,
                input,
                input_low,
                input_range,
        ...
        default:
            return q_single_scale_dpcpp_backward(
                grad_output,
                input,
                input_low,
                input_range,
